      ...
      <div className="px-6 py-6 hover:bg-blue-50/30 transition-colors bg-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center flex-shrink-0 min-w-0" style={{ width: '340px' }}>
            ...
            {/* Endereço */}
            <div className="flex-shrink-0 hidden lg:block min-w-0" style={{ width: '300px' }}>
            ...
            {/* Info de parcerias */}
            <div className="flex-shrink-0 hidden md:block min-w-0" style={{ width: '240px' }}>
              {hasPartnerships ? (
